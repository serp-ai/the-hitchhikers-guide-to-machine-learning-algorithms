...
To use this code, you will need to define your own State class that implements the get\_next\_state, get\_legal\_actions, is\_terminal, and get\_result methods. You can then create an instance of the MCTS class and call the search method to perform the search.
...
\*\[MCTS]: Monte Carlo Tree Search [Monte Carlo Tree Search](https://serp.ai/monte-carlo-tree-search/)
